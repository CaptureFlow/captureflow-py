...
class CallGraph:
    ...
    def find_node_by_fname(self, function_name: str) -> list[any]:
        ...
        logger.info(f"MATCHING {matching_nodes}")
...
if __name__ == "__main__":
    log_file_path = "/Users/nikitakutc/projects/captureflow-py/serverside/trace_e281f30f-6f57-42b3-b975-e2c9c8afeffa.json"
