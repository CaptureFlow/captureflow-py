...
def test_build_graphs_from_redis(mock_redis_client, sample_trace_json):
    orchestrator = Orchestrator(redis_client=mock_redis_client, repo_url="https://github.com/NickKuts/capture_flow")

    call_graphs = orchestrator.build_graphs_from_redis(mock_redis_client, "https://github.com/NickKuts/capture_flow")
